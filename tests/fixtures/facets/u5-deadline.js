...
export const cases = [
  ...
  caseWith('u5-none-explicit-no-required-by', 'The review is next month, but nobody has supplied a required-by date.', 'none', true, 'no-deadline', 'event-contrast'),
  caseWith('u5-none-indirect-required-by', 'The review is next month, but nobody has given the team a required-by date.', 'none', true, 'no-deadline', 'event-contrast'),
  caseWith('u5-observed-morning', 'We noticed the failure this morning.', 'unknown', false, 'timestamp', 'negative', 'noise'),
  caseWith('u5-observed-use-today', 'The access control was used today and the result was checked.', 'unknown', false, 'timestamp', 'negative', 'observation'),
