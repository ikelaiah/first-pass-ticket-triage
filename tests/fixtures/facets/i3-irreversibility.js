...
export const cases = [
  ...
  positive('i3-privacy-wrong-address', 'A parent can open another family\'s address in the portal.',
    { risks: ['privacy'], modifiers: { exposureActive: true } }, 'privacy', 'active'),
  positive('i3-privacy-cross-department-disciplinary-note',
    "A case officer in another department can open one student's disciplinary note.",
    { risks: ['privacy'], modifiers: { exposureActive: true } }, 'privacy', 'active'),
  positive('i3-privacy-former-volunteer-welfare-plans',
    "The account for a volunteer who left still opens three students' welfare plans.",
    { risks: ['privacy'], modifiers: { exposureActive: true } }, 'privacy', 'active'),
  positive('i3-privacy-guardian-different-student-balance',
    "A guardian could read a different student's fee-balance details.",
    { risks: ['privacy'], modifiers: { exposureActive: true } }, 'privacy', 'active'),
  ...
  positive('i3-safety-alert', 'The allergy alert is missing during today\'s excursion.',
    { risks: ['safety'] }, 'safety'),
  positive('i3-safety-eyewash-control-failed',
    'The eyewash station valve is dry while students are using the lab this afternoon.',
    { risks: ['safety'], symptom: 'safety-control-failed' }, 'safety', 'active'),
