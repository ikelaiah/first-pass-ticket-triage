...
export const cases = [
  ...
  positive('i1-seasonal-history-current-narrow', 'Last winter every campus timed out. Today only one adviser sees an empty view.', 'individual', 'history', 'comparison'),
